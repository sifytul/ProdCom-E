                  ...
                  <div className="p-4 bg-green-50">
                    <div>
                      <p>
                        ...
                        সরাসরি *167# ডায়াল করে "Send Money (সেন্ড মানি)" অপশনটি
                        সিলেক্ট করুন।
                      </p>
                      <p>
                        আমাদের নগদ নাম্বার "01859667631" এ আপনার মোট বিল প্রদান
                        করুন।
                      </p>
                      <p>
                        বিঃদ্রঃ শুধুমাত্র "সেন্ড মানি" অপশন এর মাধ্যমে বিল
                        পরিশোধ করতে হবে Nagad Personal Number : 01859667631
                      </p>
                    </div>
                    <div>
                      <div>
